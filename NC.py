...
def run_NC():
 ...
 try:
     ...
     if 'hello' in command :
         ...
         print('I am NC a k a your virtual assistant master')
         engine_talk('I am NK a k a your virtual assistant master. how can i help you ??')
     ...
     elif 'stop' or 'Close' or 'shutdown' in command:
         print('good bye, have a nice day !!')
         engine_talk('good bye, have a nice day !!')
         sys.exit()
...
print("hello, i am NC how can i help you ??")
engine_talk ("hello i am NC your Personal Voice assistant Mister Sahil Agarwal ")
